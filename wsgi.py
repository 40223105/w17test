...
class Hello(object):
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150628131101.1: *3* geardraw
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def geardraw(self, N=15, N1=24,N2=15, N3=24,N4=15,N5=24,M=10, P=20):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    <form method=POST action=drawaction>
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150628131113.1: *3* drawaction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawaction(self, N=15, N1=24,N2=15,N3=24,N4=15,N5=24,M=10, P=20):
        outstring =''' 
    <!DOCTYPE html> 
    <html>
    <head>
